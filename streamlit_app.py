...
#Lets add a pick list so customers can choose what fruit they want
...
add_my_fruit = streamlit.text_input('What fruit would you like to see added?', '')
